export const site = {
  ...
  description:
    "The growth agency for healthcare, pharma, biotech, medical devices, and life sciences. One senior team owns the pipeline from the first search to the booked meeting. You close.",
