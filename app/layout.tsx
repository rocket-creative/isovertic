...
import { organizationLd, peopleLd } from "@/lib/schema";
...
export const metadata: Metadata = {
  ...
  title: { default: "ISOVERTIC | Growth Agency for Healthcare, Pharma, Biotech, Medical Devices, and Life Sciences", template: "%s | ISOVERTIC" },
