...
export function GET() {
  ...
  const lines = [
    ...
    `- Every tier is a minimum one year term; there is no month to month option. Every tier checks out at ${u}/start by card or ACH bank debit, no call. Baseline and Catalyst bill the term monthly, quarterly at 4 percent off, or up front at eleven months for twelve. Kinetic and Critical Mass are paid quarterly. Engagement length and measurement standard: ${u}/resources/engagement-and-measurement-standard`,
