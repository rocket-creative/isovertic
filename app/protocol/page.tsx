...
const faqs = [
  ...
  { q: "Who teaches it?", a: "The founder, on every Protocol. Thirty years building brands, products, and demand, and every runbook in the library was written from an account we run." },
];
...
export default function Protocol() {
  return (
    <>
      ...
      <PageHero
        eyebrow="Protocol · For teams that run it themselves"
