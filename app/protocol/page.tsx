...
export const metadata: Metadata = {
  ...
  description: "Protocol is the training offer for healthcare, pharma, biotech, medical devices, and life sciences. One or two days at your office, eight runbooks. $5,000 or $20,000.",
