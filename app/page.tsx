...
const homeFaqs = [
  ...
  { q: "What does it cost?", a: "Engagements start at $3,000 per month for publishing and run to $25,000 and up for multi-brand programs with television. Every package is a 12-month engagement that includes the $15,000 website rebuild and hosting. Every package, every add-on, and the term table are on the pricing page, and every package checks out on the page by card or bank debit, no call." },
