        ...
        <div className="mx-auto max-w-[1440px] gutter py-24">
          <RevealBlock>
            ...
            <p className="mt-6 max-w-[58ch] leading-relaxed text-ink/85">
              Every engagement starts with a defined 90 day ramp and stated deliverables for your tier. Kinetic and above carry a meeting volume commitment in writing. Every tier is a one year term, because that is how long it takes for pipeline and revenue to move and we would rather say so than sell a shorter window. Inside the year, leading indicators arrive every 30 days and revenue is judged at months six and twelve.
            </p>
