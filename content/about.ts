...
export const about = {
  ...
  team: {
    ...
    roles: [
      ...
      { title: "Photographers.", body: "Same standard, for stills. No stock photography ships from this agency." },
    ...
    close: 'The reason we can say "the same senior team on every tier" is that the team exists. When an Amplification account needs a compliance review, a Google Ads restructure, and a video shoot in the same week, all three people are already here.',
  },
  george: {
  ...
  work: {
    h2: "How we work",
    body: [
      "The founder stays on every account as the standards owner. The same senior team runs Ground State and Quantum Leap; the price buys steps, not a better team.",
      "Pricing is published because our buyer hates a wasted discovery call as much as we do.",
      "Every engagement is a 12-month term, staged as a 3-month foundation into a 9-month growth term. We report leading indicators every 30 days (rankings, impressions, cost per lead, learning-phase status) and review lagging indicators (pipeline, revenue, CAC payback) at 6 and 12 months, tied to your actual sales cycle. Healthcare, biotech, and medtech sales cycles run 125 days to 24 months, so a lead we generate in month 2 may not close until month 12 or later. We build the review cadence around that reality instead of asking you to judge a 12-month system on a 90-day clock.",
