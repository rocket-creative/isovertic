...
export const method = {
  ...
  tiers: {
    ...
    intro: "Pick a tier and we run the steps in it. Ground State runs step two. Excitation runs one through three. Amplification runs everything but TV. Quantum Leap runs all of it, per brand. Step six is Protocol, bought on its own or added to any tier.",
    items: [
      { name: "Ground State.", body: "$2,500 per month on a 12-month term. The content drumbeat, running without meetings." },
      { name: "Excitation.", body: "$5,000 per month on a 12-month term, plus ad spend. Content plus paid demand, with a human on the account." },
      { name: "Amplification.", body: "$10,000 per month on a 12-month term, plus ad spend. The full pipeline. The flagship engagement." },
      { name: "Quantum Leap.", body: "From $25,000 per month on a 12-month term, plus media. For companies running more than one brand, ready to own a market, or growing faster than the business behind the pipeline can handle. This is the tier where we go inside the company first: map how a lead moves through it, find where it leaks, automate what does not need a person, write the SOPs, then turn up the ads and outbound." },
    ],
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "The same senior team on every tier, running the method George engineered and Kristen built the operation around. There is no junior tier of staff behind the lower price. The lower price buys fewer steps, not a different team. George is the source and the escalation path on every account.",
    },
    {
