...
export const complianceFaqs: FAQ[] = [
  ...
  { q: "Do you have a SOC 2 report?", a: "No, and we will not imply we do. SOC 2 is an attestation an outside CPA firm issues after auditing a vendor, and ours has not been written. What your security team gets instead: your questionnaire completed in writing, the data flow map, the tooling register, the subprocessor list, and the certificate of insurance. If your program requires a SOC 2 report from every vendor, we are not a fit, and we would rather say that now than after you sign." },
