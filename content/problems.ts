  ...
  },
  {
    ...
    sections: [
      ...
      { h2: "Why the specific page beats the big one", body: [
        "The AI layer does not quote the most authoritative site on the topic. It quotes the page that answers the exact question asked. A buyer who asks a specific question, the kind a specialist asks, gets a specific citation, and the big competitor's overview page is not it. That is the same reason the long tail works in ordinary search, and it is why we build one page per question instead of one page per topic. The company with two hundred specific pages gets cited two hundred ways. The company with one good pillar page gets summarized and skipped.",
      ]},
