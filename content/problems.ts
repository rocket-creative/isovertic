...
export const problems: Problem[] = [
  // OWNERS AND FOUNDERS
  {
    ...
    metaDescription: "You hired a marketer and the phone did not ring. The cause is usually the job description, not the person. What one marketer can produce, and the three options.",
  ...
  },
  {
    ...
    metaDescription: "Six months, a retainer, a report full of impressions, no meetings. Why agencies get paid for activity, the questions that expose it, and what to buy instead.",
    eyebrow: "Problem · Owners",
  ...
  },
  {
    ...
    metaDescription: "Two thousand visits a month and four form fills. The five reasons a site converts under 1 percent, and how to find yours in ten minutes.",
    eyebrow: "Problem · Owners",
  ...
  },
  {
    ...
    metaDescription: "Referrals are a ceiling, not a strategy. What happens when the two people who send you work retire, and how to add one channel you control.",
    eyebrow: "Problem · Owners",
  ...
  },
  {
    ...
    metaDescription: "The rep ramped for four months, booked little, and left. Why first sales hires fail on the pipeline, not the person, and how to rebuild without hiring again.",
    eyebrow: "Problem · Owners",
  ...
  },
  {
    ...
    metaDescription: "Spend is flat, leads are down, cost per lead is up. The four account level causes, the 2026 benchmarks, and why the fix is on the page, not in the bid.",
    eyebrow: "Problem · Owners",
  ...
  },
  {
    ...
    metaDescription: "Reply rates under 1 percent are a list problem 80 percent of the time. What the 11 percent teams do differently, and how a technical market changes the rules.",
    eyebrow: "Problem · Owners",
  ...
  },
  {
    ...
    metaDescription: "Your competitors rank for the service you are better at. The usual cause is page count, not backlinks. What a 12 page site ranks for versus a 150 page site.",
    eyebrow: "Problem · Owners",
  ...
  },
  {
    ...
    metaDescription: "Ranking on Google does not put you in the AI answer. Only 12 percent of AI cited URLs overlap with Google's top ten. The four page traits that get cited.",
    eyebrow: "Problem · Owners",
    ...
    related: [{ label: "How to get cited in AI search", href: "/field-notes" }, { label: "What is AEO", href: "/answers/what-is-aeo" }, { label: "SEO and content", href: "/seo-content" }],
  },
  {
    ...
    metaDescription: "The site is six years old, slow on mobile, and every change goes through the vendor who owns the hosting. How to get out, and what a rebuild costs.",
    eyebrow: "Problem · Owners",
  ...
  },
  {
    ...
    metaDescription: "Nobody publishes prices, so you cannot budget. Real 2026 numbers for channel vendors, in house hires, appointment setting, and full pipeline programs, by stage.",
    eyebrow: "Problem · Owners",
  ...
  },
  {
    ...
    metaDescription: "$40,000 for a booth, 200 badge scans, four follow up calls, zero deals. Why event ROI disappoints, and how to book the meetings before you fly.",
    eyebrow: "Problem · Owners",
  ...
  },
  {
    ...
    metaDescription: "Three posts a week, a monthly blog, a growing follower count, and no leads. Why engagement is not demand, what content produces meetings, and the cadence.",
    eyebrow: "Problem · Owners",
  ...
  },
  {
    ...
    metaDescription: "Leads arrive and nobody knows from where. The five tracking failures in almost every account, and how to see cost per meeting by channel in 30 days.",
    eyebrow: "Problem · Owners",
  ...
  },
  {
    ...
    metaDescription: "The vendor reports 15 meetings booked. Six held. Two were qualified. Why meetings booked into a weak brand ghost, and what a qualified meeting standard says.",
    eyebrow: "Problem · Owners",
    ...
    callout: {
      label: "Where this lives",
      body: "On Amplification, we define what counts as a meeting, we verify each one, and we report cost per qualified meeting. Held meetings with people who match agreed criteria count. No shows and meetings that fail criteria do not. Every booked meeting gets a confirmation sequence. Pricing is published.",
    },
    ...
    faqs: [
      { q: "Should we pay per meeting or a retainer?", a: "Pay per held qualified meeting if a vendor offers it. Most offer pay per booked, which creates exactly this problem. Our seat is a retainer. We define what counts, we verify each meeting, and we report cost per qualified meeting." },
  ...
  },
  {
    ...
    metaDescription: "A research line and a clinical line, or two brands under one company. How to run both without doubling headcount, and what the second brand costs.",
    eyebrow: "Problem · Owners",
  ...
  },
  {
    ...
    metaDescription: "A great quarter, then the cliff, then the scramble. Feast and famine revenue has five known causes and one fix: a demand system that runs when you are busy.",
    eyebrow: "Problem · Owners",
  ...
  // LIFE SCIENCE AND CRO
  {
    ...
    metaDescription: "A catalog of thousands of models or reagents and Google indexes a search box. Why a database ranks as one page, and what 14,000 indexed pages did to leads.",
  ...
  },
  {
    ...
    metaDescription: "Every new client trained in the same two labs, and the founders are the sales team. Small CRO business development without a sales hire.",
    eyebrow: "Problem · Life science",
  ...
  },
  {
    ...
    metaDescription: "The blog has one post from March because every draft waits for a scientist's spare afternoon. The weekly workflow with a named reviewer that ships.",
    eyebrow: "Problem · Life science",
  ...
  },
  {
    ...
    metaDescription: "The generalist SDR reads a script to a PI who knows more than they do, and the PI hangs up. Why volume shops fail with scientific buyers.",
    eyebrow: "Problem · Life science",
  ...
  },
  {
    ...
    metaDescription: "You email principal investigators and hear nothing. The PI is rarely the buyer of record under $50,000. Who is, and when in the grant cycle to send.",
    eyebrow: "Problem · Life science",
  ...
  },
  {
    ...
    metaDescription: "Flush in the fall, dead in July. Why life science revenue follows study section dates, and how to time outreach and content to flatten the curve.",
    eyebrow: "Problem · Life science",
  ...
  },
  {
    ...
    metaDescription: "You lose deals to firms ten times your size and think it is because you are small. It is because your site says flexible and client focused.",
    eyebrow: "Problem · Life science",
  ...
  // HEALTHCARE
  {
    ...
    metaDescription: "Referrals are 80 to 90 percent of new patients for specialists, and one retirement removes a third of next year. Treat referring physicians as a market.",
  ...
  },
  {
    ...
    metaDescription: "You added a program, trained the staff, bought the equipment, and the schedule is empty. Why a paragraph on the services page cannot fill it.",
    eyebrow: "Problem · Healthcare",
  ...
  },
  {
    ...
    metaDescription: "Ads disapproved, account limited, an agency that cannot explain why. Which healthcare categories need LegitScript certification, and how long it takes.",
    eyebrow: "Problem · Healthcare",
  ...
  },
  {
    ...
    metaDescription: "One location is booked six weeks out and another is half empty. Why one campaign and one site cannot balance a group, and the per location fix.",
    eyebrow: "Problem · Healthcare",
  ...
  },
  {
    ...
    metaDescription: "A newer practice with worse outcomes shows up first when patients search your specialty and town. What the map pack ranks on, and review velocity.",
    eyebrow: "Problem · Healthcare",
  ...
  },
  {
    ...
    metaDescription: "Legal and compliance block every campaign, so the brand publishes nothing. How to separate what needs review from what does not, and a weekly gate.",
    eyebrow: "Problem · Healthcare",
  ...
  // STARTUPS
  {
    ...
    metaDescription: "The board wants top of funnel before it funds the bottom. What to build before hiring an SDR who ramps for four months and leaves in fourteen.",
  ...
  },
  {
    ...
    metaDescription: "The board asks for pipeline coverage and you have a list of conversations. How to give a board a committed number before you have a sales team.",
    eyebrow: "Problem · Startups",
    ...
    callout: {
      label: "Where this lives",
      body: "Every tier states its deliverables in the agreement. Amplification at $10,000 a month adds meetings verified against the meeting quality standard. Paste the agreement into the board update and report against it. Pricing is published so the cost line is already in the model.",
    },
  ...
  },
  {
    ...
    metaDescription: "Every landing page is a sprint ticket, or the site lives on a builder engineers refuse to touch. The stack marketing can run and engineering keeps.",
    eyebrow: "Problem · Startups",
  ...
  },
  {
    ...
    metaDescription: "New name, new site, and inbound fell off a cliff because nothing carried over. How to run a rebrand so the pipeline runs under the new name by month two.",
    eyebrow: "Problem · Startups",
  ...
  {
    slug: "more-leads-would-break-us",
    audience: "owners",
    dateModified: "2026-09-08",
    title: "More Leads Would Break Us: What to Fix First",
    metaDescription: "You do not want more leads, you want the ones you have to stop costing you sleep. Why the fix starts inside the company, and what the operations audit delivers.",
    eyebrow: "Problem · Owners",
    h1: "More leads would break us. The business behind the pipeline cannot take the growth.",
    lead: "You are not short on inquiries. You are short on hours, and every new job lands on the same three people who are already behind. So when someone offers you more leads, the honest reaction is dread. That is not a marketing problem and we will not sell you marketing for it. It is a flow problem: a lead enters the company and nobody can draw the path it takes from there.",
    callout: {
      label: "Where this lives",
      body: "Quantum Leap, from $25,000 a month, starts inside the company before it turns up the ads and outbound. The operations audit maps how a lead moves through your business, finds where it leaks, builds the automations that remove the steps that do not need a person, and writes the SOPs. The pipeline work comes after. Pricing is published.",
    },
    searchPhrases: ["too busy to take on more customers", "business cannot handle more leads", "owner overwhelmed by growth", "we get inquiries but cannot keep up", "grow the business without drowning"],
    sections: [
      { h2: "Why more leads feel like a threat", body: [
      ...
      { h2: "What we do before we add a single lead", body: [
      ...
      { h2: "What you get, and what we do not promise", body: [
    ...
    faqs: [
      { q: "Is this consulting or marketing?", a: "Both, in that order. The first ninety days are inside the company. The rest of the year is the six step pipeline, run on the path we cleaned up." },
      { q: "We are thinking about selling the company. Does this still make sense?", a: "Sometimes. A buyer pays more for a business that runs without its owner, and the map and SOPs are what a buyer asks for in diligence. But if the sale is likely inside a year, say so on the call and we will tell you whether to wait." },
      { q: "Can we do the audit without the pipeline work?", a: "Not on the site. Quantum Leap is a year, and the audit is the first part of it. If you only want the audit, book the call and we will scope it straight, which may mean pointing you elsewhere." },
    ],
    related: [pricing, howItWorks, { label: "Take the Pipeline Ownership Audit", href: "/audit" }],
  },
  {
    slug: "scientists-who-know-nothing-about-marketing",
    audience: "life-science",
    dateModified: "2026-09-08",
    title: "Scientists Who Know Nothing About Marketing",
    metaDescription: "A company spun out of a lab, a product that works, and nobody who has run marketing. The three things to do first, and what the first year costs.",
    eyebrow: "Problem · Life science",
    h1: "We are scientists. We know the product and nothing about marketing, and we do not know where to start.",
    ...
    sections: [
      { h2: "The good news about selling to scientists", body: [
        "Your buyer searches the way you do: by gene, by method, by catalog number, by the exact phrase from the paper. Those searches are specific, and almost nobody competes for them, because the big suppliers rank for the category and ignore the long tail. A page that answers the specific question, with the specification and the reference on it, gets found by the one person who typed that question. That is the whole method, and it rewards precision over polish.",
        "It also means the two things most new companies buy first, a logo refresh and a LinkedIn cadence, are the two you can skip for now. Nobody chose a mouse model because of the supplier's logo.",
      ]},
      { h2: "The three things to do in the first ninety days", body: [
        "First, a site that says what you sell in the words a researcher would type, one page per product or service, server rendered so Google and the AI engines can read it. That build is included in every tier. Second, one piece of writing a month that answers a question your customers actually ask you on calls, with the citation. Third, a form that goes somewhere, a person who answers it inside a business day, and a spreadsheet or CRM that records where each inquiry came from. That last one is the step scientists skip, and it is the one that tells you in month six whether any of this worked.",
      ]},
      { h2: "What the first year looks like", body: [
        "Months one through three are the build and the first publishing cadence. Months three through six are when specific pages start to get found, usually for searches you did not plan for, which tells us what to build next. Months six through twelve are when paid search makes sense, because by then you know which terms convert. We report leading indicators every 30 days and judge revenue at months six and twelve, tied to your sales cycle, which in life science runs six to eighteen months. Nobody will ask you to judge a year of work at day 90.",
      ]},
    ],
    faqs: [
  ...
  {
    slug: "government-sites-and-law-firms-outrank-us",
    audience: "healthcare",
    dateModified: "2026-09-08",
    title: "Buyers Search a Code and Law Firms Outrank Us",
    metaDescription: "Billing directors search by procedure code, statute, and form number. The head term belongs to CMS and law firms. The long tail belongs to nobody.",
    eyebrow: "Problem · Healthcare",
    h1: "Our buyers search a code or a regulation and government sites and law firms outrank us.",
    lead: "Your buyer is a billing director, a practice administrator, or a compliance lead, and they search the way they work: a CPT code, a statute section, a form number, a deadline. Type the generic term and the first page is CMS, a state agency, and four law firms with fifty attorneys each. You will not outrank them for that term, and you do not need to. The specific searches underneath it, the code plus the situation plus the question, are wide open.",
    callout: {
      label: "Where this lives",
      body: "Excitation at $5,000 a month: the site rebuilt around the questions your buyers type, one page per code or scenario, plus one Google Ads campaign on the specific terms and a landing page for each. The HIPAA form and call stack add on at $750 covers intake where the inquiry contains patient information. Pricing is published.",
    },
    searchPhrases: ["how to rank for cpt code searches", "healthcare software seo law firms outrank us", "rank for regulation keywords small company", "billing software content strategy procedure codes", "compete with government sites on google"],
    sections: [
      { h2: "Why the head term is not yours and never will be", body: [
        "A government site is the primary source. A law firm has a decade of articles and a building full of people whose job is to write about the statute. Google is right to rank them for the generic term, and a campaign to beat them is a year of spend to reach page two. The mistake is treating that term as the market. It is the dictionary entry. Your buyer does not need the dictionary. They need to know what to do about this code, on this claim, before Friday.",
      ]},
      { h2: "The long tail nobody is writing for", body: [
        "Take one code and list the situations a billing director actually faces with it: the denial reason, the appeal window, the documentation that gets it paid, the payer that handles it differently. Each of those is a page, written in the vocabulary the buyer uses at work, with the primary source cited and a form at the bottom. Government sites do not write that page because they do not sell anything. Law firms do not write it because it is not a case. So the person who searches it lands on you, and they are usually the person who signs.",
        "We ran exactly this for a healthcare technology company that did not exist online at the start. Site modeled on what buyers type, long tail pages, one targeted campaign. Ninety days from a blank domain to page one for the specific searches, and about one qualified lead a week on roughly $1,000 a month in ads. The study, with the window and the method, is on the results page.",
      ]},
      { h2: "What it takes on your side", body: [
        "Someone who can list the twenty situations your customers call about, because that list is the sitemap. A reviewer who can confirm a regulatory claim before it publishes. And intake that handles patient information correctly, since a billing question often arrives with a claim attached, which is why the HIPAA stack sits beside this page.",
      ]},
    ],
    faqs: [
      { q: "How long before the specific pages rank?", a: "When the pages are live at launch, the specific searches show impressions in weeks. In the case above, the last four weeks of the ninety day window were measured against the first four, and the multiples are on the results page." },
      { q: "Do we need paid search too?", a: "One campaign on the specific terms gives you demand from day one while organic compounds, and it tells us which terms convert so we build those pages first." },
      { q: "Is this only for billing software?", a: "It is for any company whose buyer searches by code, statute, form, or regulation. Revenue cycle, compliance software, medical devices sold on a reimbursement story, and specialty practices that bill complex procedures all fit." },
    ],
    related: [{ label: "Results", href: "/results" }, { label: "Healthcare industry page", href: "/industries/healthcare" }, { label: "HIPAA posture", href: "/compliance/hipaa-posture" }],
  },
  {
    slug: "not-sure-anyone-searches-for-what-we-sell",
    audience: "startup",
    dateModified: "2026-09-08",
    title: "We Are Not Sure Anyone Searches for What We Sell Yet",
    metaDescription: "A new category, a product nobody has a word for, and a search bar that returns nothing. How to find out in two weeks whether search demand exists.",
    eyebrow: "Problem · Startups",
    h1: "We are not sure anyone searches for what we sell yet.",
    lead: "You built something new enough that the buyer does not have a name for it. So when you type the product into Google, you get nothing, and when you type the problem it solves, you get companies solving a different problem. This is the one situation where our method may not be the right buy, and we would rather say that on this page than on an invoice. The good news is that the question has a two week answer.",
    callout: {
      label: "Where this lives",
      body: "Before any tier. Send us your best page and your three closest customer conversations, and we will tell you in about ten minutes whether people are already searching for the problem in words we can build pages for. If they are, Ground State or Excitation. If they are not, we will say so, and we will tell you what to do instead. Pricing is published.",
    },
    searchPhrases: ["no search volume for our product", "marketing a product nobody searches for", "new category startup seo does not work", "how to know if there is search demand for my product", "nobody knows they need our product yet"],
    sections: [
      { h2: "The honest limit, stated first", body: [
        "Our method finds the buyer who is already searching for what you sell, in specific terms, and puts the right page in front of them. It works because the demand exists and is unclaimed. If the demand does not exist yet, no page can find it, and paid search on a term nobody types buys nothing. Category creation is a different playbook: it runs on founder writing, conversations, events, and a long patient loop of teaching a market its own vocabulary. It is real work, it is slower, and it is not what we sell.",
      ]},
      { h2: "How to find out in two weeks", body: [
        "Nobody searches for the product. Plenty of people search for the situation. Take your last ten sales calls and write down, in the customer's words, what they were trying to do before they found you. Not your category name, their task. Then check whether those phrases have searches behind them, whether the results are answering them well, and whether a page written for that task would lead a reader to your product. Usually two or three of the ten phrases have demand, and those become the first pages. Occasionally none do. Both answers are useful, and the second one saves you a year of spend.",
      ]},
      { h2: "What we do in each case", body: [
        "If the situational searches exist, we start on Ground State or Excitation and build for the situation, not the category. The page answers the task the buyer typed and introduces the product as the way to do it. That is how a new category gets discovered by people who never heard its name. If the searches do not exist, we tell you, and we will point you toward the founder led content and outbound motion that fits a category creator. We may still be the right team for the site and the outbound, but we will not sell you a search program that has nothing to search.",
      ]},
    ],
    faqs: [
      { q: "Can paid search create demand?", a: "No. Paid search serves an ad to someone who already typed the term. If nobody types it, the campaign spends nothing and produces nothing, which is at least cheap." },
      { q: "What about AI search? Do people ask ChatGPT for products like ours?", a: "Sometimes before they search Google for them, because a person can describe a problem to an AI without knowing the category name. Pages written for the situation are what those engines cite, so the answer is the same: build for the task." },
      { q: "You would really turn us away?", a: "Yes. A client who leaves in month four because the method could not work is worse for us than a call that ends with a referral. Sometimes the honest answer is that you are not ready for us, and we will say so and hand you back your afternoon." },
    ],
    related: [{ label: "Startup industry page", href: "/industries/startups" }, howItWorks, contact],
  },
  {
    slug: "google-ai-answers-the-question-and-nobody-clicks",
    audience: "owners",
    dateModified: "2026-09-08",
    title: "Google AI Answers the Question and Nobody Clicks",
    metaDescription: "Impressions are up, clicks are down, and the answer box quotes someone else. What AI-generated answers cite, and how to become the citation.",
    eyebrow: "Problem · Owners",
    h1: "Google's AI answers the question and nobody clicks through to us.",
    ...
    sections: [
      { h2: "What the answer layer actually cites", body: [
        "Look at the three citations under any AI answer. They share a shape: a page that states the answer plainly near the top, in one or two sentences a machine can lift, followed by the detail, the numbers, and the source. The page loads as text, not as a JavaScript app that renders after the fact. It carries schema that tells the engine what kind of thing it is. And it answers one specific question rather than eleven vaguely. Most sites fail on two of those four, and the ones that fail on the first, the crawlable text, fail silently, because the site looks fine to a human.",
      ]},
      { h2: "Why the specific page beats the big one", body: [
        "The AI layer does not quote the most authoritative site on the topic. It quotes the page that answers the exact question asked. A buyer who asks a specific question, the kind a scientist or clinician asks, gets a specific citation, and the big competitor's overview page is not it. That is the same reason the long tail works in ordinary search, and it is why we build one page per question instead of one page per topic. The company with two hundred specific pages gets cited two hundred ways. The company with one good pillar page gets summarized and skipped.",
      ]},
      { h2: "What we change on your site", body: [
        "Server rendering, so every page returns its full text to any crawler. The simplest test is to request the page with JavaScript off and read it. Schema on every page through typed builders, not a plugin. A structured answer at the top of every page and post, written by a person who knows the field, with the source cited. Then a monthly cadence of new pages built from what Search Console says people asked, so the site keeps earning citations for questions we did not plan for.",
      ]},
    ],
    faqs: [
      { q: "Is this the same as SEO?", a: "It is SEO for the layer that now sits above the links. The technical work overlaps. The writing changes: a citable page states the answer first, which is the opposite of how most blog posts are built." },
      { q: "Does this apply to ChatGPT and Perplexity too?", a: "Yes. They read the same text and the same schema, and they favor the same specific pages. Getting cited in one usually means being cited in the others within a few weeks." },
      { q: "Can we do this on WordPress?", a: "Partly. The writing changes work anywhere. The crawlable text and the schema are the reason the rebuild is included in every tier." },
    ],
    related: [{ label: "SEO and AI search", href: "/seo-content" }, { label: "Competitors show up in ChatGPT", href: "/problems/competitors-show-up-in-chatgpt-and-we-do-not" }, pricing],
  },
  {
    slug: "buyers-read-the-docs-and-never-talk-to-sales",
    audience: "owners",
    dateModified: "2026-09-08",
    title: "Buyers Read the Docs and Never Talk to Sales",
    metaDescription: "Engineers evaluate with documentation and a trial and treat sales as a last resort. How to build a pipeline for a buyer who distrusts marketing.",
    eyebrow: "Problem · Owners",
    h1: "Our buyers read the docs, try the product, and never talk to sales.",
    ...
    sections: [
      { h2: "How an engineer actually buys", body: [
        "The evaluation happens on your site and off your calendar. Docs first, then pricing, then a comparison against the two alternatives they already know, then a trial in a sandbox, then a question in a community where you are not present. Every one of those steps is a page you either wrote or did not. A site that hides pricing behind a form loses the visit at step two. A docs section that reads like marketing loses it at step one. The buyer is not avoiding you. They are doing diligence in the order that makes sense to them, and most vendor sites are built in a different order.",
      ]},
      { h2: "Build for the order they evaluate in", body: [
        "Documentation and pricing one click from anywhere. Comparison pages that are honest about where the alternative wins, because an engineer who catches one dishonest line discounts the whole site. Integration pages, one per system they already run. How it works pages written by someone who can read a changelog, structured so the AI engines that now answer developer questions can cite them. Then paid search on the specific terms, steered by cost per qualified meeting, so the one engineer who does want to talk gets a page and a calendar instead of a form.",
      ]},
      { h2: "The meeting, when it finally happens", body: [
        "Outbound to an engineering lead only works when the message references something true: their stack, their last release, the problem in their own job posting. Generic sequences to engineers get reported as spam, and we do not send them. On Amplification, the seat sends specific messages, a person who can answer a technical reply takes the response, and a meeting is defined in writing before the program starts, so a qualified conversation with an engineering decision maker counts and a curious trial signup does not.",
      ]},
    ],
    faqs: [
  ...
  },
  {
    ...
    audience: "owners",
    dateModified: "2026-09-08",
    title: "Our Partners Are the Brand and None of Them Will Write",
    metaDescription: "In a professional services firm the experts are billable, so nobody writes. How to get a principal's point of view onto the page in under an hour a month.",
    eyebrow: "Problem · Owners",
    h1: "Our partners are the brand and none of them will write.",
    ...
    sections: [
      { h2: "Why the firm page cannot carry the brand", body: [
        "A buyer choosing a firm is choosing a person to trust with a problem. The firm page, written in the firm's voice, gives them nothing to trust: services listed, industries served, values stated. The partner page with a real point of view, on a real question that client asks, is what gets forwarded. Personal profiles outperform company pages in B2B for that reason, and a firm whose partners are silent online is invisible to the referred prospect doing a quiet check before the first call.",
      ]},
      { h2: "Capture, do not commission", body: [
    ...
    faqs: [
      { q: "Can you write in more than one partner's voice?", a: "Yes. Each partner gets their own captured voice and approval workflow. The pieces read differently because the people are different." },
      { q: "Our deals come from referrals. Why do we need this?", a: "Because the referred prospect checks you before they call, and a partner with nothing published loses the check to the competitor with three good articles. Referrals are a ceiling, not a strategy." },
      { q: "Is this appropriate for regulated professions?", a: "We build inside advertising rules for legal, financial, and accounting professions per jurisdiction, and every claim carries a source." },
    ],
    related: [{ label: "Professional services industry page", href: "/industries/professional-services" }, { label: "Field notes", href: "/field-notes" }, pricing],
  },
];
